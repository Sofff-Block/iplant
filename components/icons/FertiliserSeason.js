...
export default function FertiliserSeason({ season, isDark }) {
  ...
  return (
    <>
      {isDark ? (
        <SeasonWrapper>
          <StyledSeasonDark $isSeason={season.includes("Spring")}>
            Spring
          </StyledSeasonDark>
          <StyledSeasonDark $isSeason={season.includes("Summer")}>
            Summer
          </StyledSeasonDark>
          <StyledSeasonDark $isSeason={season.includes("Fall")}>
            Fall
          </StyledSeasonDark>
          <StyledSeasonDark $isSeason={season.includes("Winter")}>
            Winter
          </StyledSeasonDark>
        </SeasonWrapper>
      ) : (
        <SeasonWrapper>
          <StyledSeason $isSeason={season.includes("Spring")}>
            Spring
          </StyledSeason>
          <StyledSeason $isSeason={season.includes("Summer")}>
            Summer
          </StyledSeason>
          <StyledSeason $isSeason={season.includes("Fall")}>Fall</StyledSeason>
          <StyledSeason $isSeason={season.includes("Winter")}>
            Winter
          </StyledSeason>
        </SeasonWrapper>
      )}
